...
public class Homepage_Inicio_sesion_componente extends javax.swing.JFrame {

    public Homepage_Inicio_sesion_componente() {
        initComponents();
        ...
        if (productos.isEmpty()) {
            ...
            Producto_panel.Mostrar_Componente(productos, this.panel_producto_contenedor, this);
        }
    ...
    private void initComponents() {
        ...
        Txt_buscar_categorias.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Txt_buscar_categoriasActionPerformed(evt);
            }
        });
    ...
    private void Txt_buscar_categoriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Txt_buscar_categoriasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Txt_buscar_categoriasActionPerformed

    private void btn_moduloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_moduloActionPerformed
        Homepage_Inicio_sesion_modulo newpagina = new Homepage_Inicio_sesion_modulo();
        newpagina.setVisible(true);
        this.dispose();
