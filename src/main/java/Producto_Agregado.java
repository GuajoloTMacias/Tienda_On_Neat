 ...
 * @author Lenovo
 */
public class Producto_Agregado extends javax.swing.JFrame {

    /**
     * Creates new form Producto_Agregado_1
     */
    public Producto_Agregado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Producto_Agregado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Producto_Agregado().setVisible(true);
            }
        });
    }
